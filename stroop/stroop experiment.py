...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sofiagerlein/stroop/stroop experiment.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "instructions_task_1_2" ---
    ...
    instrText = visual.TextStim(win=win, name='instrText',
        text="\nPress the 'b' key for words in blue, and 'p' for words in pink.\n\nIf you are ready, press the 'SPACEBAR' to continue.",
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "trial_task_1" ---
    ...
    # --- Initialize components for Routine "instructions_task_2" ---
    ...
    # --- Initialize components for Routine "instructions_task_2_3" ---
    ...
    # --- Initialize components for Routine "trail_task_2" ---
    ...
    # --- Prepare to start Routine "instructions_task_1_2" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instructions_task_1_2.started', globalClock.getTime(format='float'))
    key_resp_2.keys = []
    key_resp_2.rt = []
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    instructions_task_1_2Components = [text, key_resp_2]
    for thisComponent in instructions_task_1_2Components:
    ...
    # --- Run Routine "instructions_task_1_2" ---
    ...
    # --- Ending Routine "instructions_task_1_2" ---
    for thisComponent in instructions_task_1_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instructions_task_1_2.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "instructions_task_1_2" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # --- Prepare to start Routine "instructions_task_1" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instructions_task_1.started', globalClock.getTime(format='float'))
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    instructions_task_1Components = [instrText, key_resp]
    ...
    for thisComponent in instructions_task_1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instructions_task_1.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    for thisTrial in trials:
        ...
        # --- Prepare to start Routine "trial_task_1" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('trial_task_1.started', globalClock.getTime(format='float'))
        ...
        _response_allKeys = []
        # keep track of which components have finished
        trial_task_1Components = [target, response]
        for thisComponent in trial_task_1Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Ending Routine "trial_task_1" ---
        for thisComponent in trial_task_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('trial_task_1.stopped', globalClock.getTime(format='float'))
        # check responses
        ...
        # the Routine "trial_task_1" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    # --- Prepare to start Routine "instructions_task_2" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instructions_task_2.started', globalClock.getTime(format='float'))
    key_resp_3.keys = []
    key_resp_3.rt = []
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    instructions_task_2Components = [text_2, key_resp_3]
    for thisComponent in instructions_task_2Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Run Routine "instructions_task_2" ---
    routineForceEnded = not continueRoutine
    while continueRoutine:
        # get current time
        t = routineTimer.getTime()
    ...
    # --- Ending Routine "instructions_task_2" ---
    for thisComponent in instructions_task_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instructions_task_2.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "instructions_task_2" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # --- Prepare to start Routine "instructions_task" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instructions_task.started', globalClock.getTime(format='float'))
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    instructions_taskComponents = [text_3, key_resp_4]
    ...
    for thisComponent in instructions_taskComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instructions_task.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    # --- Prepare to start Routine "instructions_task_2_3" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instructions_task_2_3.started', globalClock.getTime(format='float'))
    key_resp_6.keys = []
    key_resp_6.rt = []
    _key_resp_6_allKeys = []
    # keep track of which components have finished
    instructions_task_2_3Components = [text_5, key_resp_6]
    for thisComponent in instructions_task_2_3Components:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Run Routine "instructions_task_2_3" ---
    routineForceEnded = not continueRoutine
    while continueRoutine:
        # get current time
        t = routineTimer.getTime()
    ...
    # --- Ending Routine "instructions_task_2_3" ---
    for thisComponent in instructions_task_2_3Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instructions_task_2_3.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "instructions_task_2_3" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # set up handler to look after randomisation of conditions etc
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('conditionswr.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        # --- Prepare to start Routine "trail_task_2" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('trail_task_2.started', globalClock.getTime(format='float'))
        key_resp_5.keys = []
        key_resp_5.rt = []
        _key_resp_5_allKeys = []
        # keep track of which components have finished
        trail_task_2Components = [trial_task_2_text, key_resp_5]
        for thisComponent in trail_task_2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Ending Routine "trail_task_2" ---
        for thisComponent in trail_task_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('trail_task_2.stopped', globalClock.getTime(format='float'))
        # check responses
        ...
        # the Routine "trail_task_2" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
